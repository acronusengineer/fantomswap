...
const USDC_FANTOM_TESTNET = new Token(
  SupportedChainId.FANTOM_TESTNET,
  "0xdEE65CaD824eD001a03215941FEb7c85D3E0aA94",
  6,
  "USDC",
  "USD//C"
);
...
const FANTOM = new Token(SupportedChainId.FANTOM, '0x4E15361FD6b4BB609Fa63C81A2be19d873717870', 18, 'FTM', 'FTM')
const WFANTOM = new Token(
  SupportedChainId.FANTOM,
...
const FANTOM_TESTNET = new Token(
  SupportedChainId.FANTOM_TESTNET,
  "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",
  18,
  "FANTOM",
...
export function isFantom(
  chainId: number
): chainId is SupportedChainId.FANTOM | SupportedChainId.FANTOM_TESTNET {
  return (
...
function getFantomNativeCurrency(chainId: number) {
  switch (chainId) {
...
export function nativeOnChain(chainId: number): NativeCurrency | Token {
  ...
  if (isMatic(chainId)) {
    ...
    nativeCurrency = getFantomNativeCurrency(chainId);
  } else {
...
export const TOKEN_SHORTHANDS: {
  ...
  USDC: {
    ...
    [SupportedChainId.FANTOM_TESTNET]: USDC_FANTOM_TESTNET.address,
