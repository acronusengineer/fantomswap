...
import fantomlogo from "assets/svg/fantom_logo.svg";
...
import { ARBITRUM_LIST, CELO_LIST, OPTIMISM_LIST, FANTOM_LIST } from "./lists";
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.FANTOM]: {
    ...
    label: "Fantom",
    logoUrl: fantomlogo,
    circleLogoUrl: fantomlogo,
    nativeCurrency: { name: "Fantom", symbol: "FTM", decimals: 18 },
    defaultListUrl: FANTOM_LIST,
  },
