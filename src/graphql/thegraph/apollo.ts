...
const CHAIN_SUBGRAPH_URL: Record<number, string> = {
  ...
  [SupportedChainId.FANTOM]:
    "https://api.thegraph.com/subgraphs/name/toriop268/equalizer-v3-fantom",
};

// const httpLink = new HttpLink({ uri: CHAIN_SUBGRAPH_URL[SupportedChainId.FANTOM] })
...
const authMiddleware = new ApolloLink((operation, forward) => {
  ...
  // }))
  operation.setContext(() => ({
    uri: CHAIN_SUBGRAPH_URL[SupportedChainId.FANTOM],
  }));
